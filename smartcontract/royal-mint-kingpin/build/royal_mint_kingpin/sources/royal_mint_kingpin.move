...
/// 
/// This Move module implements a chess game tracking system with NFT rewards
/// for winners, deployed on Sui blockchain for OneHack 2.0 hackathon.
///
/// Features:
/// - NFT minting for game winners (GameVictoryNFT)
/// - Player statistics tracking (wins, losses, draws)
/// - Support for PvP and PvAI games
