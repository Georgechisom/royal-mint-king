/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b30e788bd0bbccb70c88a468862abfb7)
...
declare namespace Cloudflare {
	interface Env {
		...
		MODEL_ID: string;
		AI_PROVIDER: string;
		AGENT: DurableObjectNamespace /* SimplePromptAgent from nullshot-agent */;
